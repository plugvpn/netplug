...
INSERT INTO "new_VPNUser" ("bytesReceived", "bytesSent", "commonName", "connectedAt", "createdAt", "endpoint", "id", "ipAddress", "isConnected", "isEnabled", "lastHandshake", "privateKey", "publicKey", "remainingDays", "remainingTrafficGB", "serverId", "updatedAt", "username") SELECT "bytesReceived", "bytesSent", "commonName", "connectedAt", "createdAt", "endpoint", "id", "ipAddress", "isConnected", "isEnabled", "lastHandshake", "privateKey", "publicKey", "remainingDays", "remainingTrafficGB", "serverId", "updatedAt", "username" FROM "VPNUser";
DROP TABLE "VPNUser";
